...
<html>
    ...
    <link href="<?php echo base_url('assests/css/dataTables.bootstrap.min.css')?>" rel="stylesheet">
  </head>
  <body>
  ...
  <script src="<?php echo base_url('assests/jquery/jquery-3.3.1.min.js')?>"></script>
  <script src="<?php echo base_url('assests/js/bootstrap.min.js')?>"></script>
  <script src="<?php echo base_url('assests/js/jquery.dataTables.min.js')?>"></script>
  ...
  <script type="text/javascript">
    ...
    function edit_book(id)
    {
        ...
        $('#form')[0].reset();
        $.ajax({
        url : "<?php echo site_url('books/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function delete_book(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('books/book_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {               
